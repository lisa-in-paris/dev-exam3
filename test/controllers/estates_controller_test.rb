...
class EstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post estates_url, params: { estate: { address: @estate.address, name: @estate.name, remarks: @estate.remarks, rent: @estate.rent, years: @estate.years } }
    end
  ...
  test "should update estate" do
    patch estate_url(@estate), params: { estate: { address: @estate.address, name: @estate.name, remarks: @estate.remarks, rent: @estate.rent, years: @estate.years } }
